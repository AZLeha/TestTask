...
\input{files}
\chapter{Группы}
\input{group__terminal}
\chapter{Структуры данных}
\input{struct_calibration_tabel}
\input{union_packet_heder}
\input{struct_terminal__state_item}
\chapter{Файлы}
\input{_a_d_c_8c}
\input{_i2_c_8c}
\input{_a_d_c_8h}
...
\input{_s_p_i_8c}
\input{_u_a_r_t_8c}
\input{_a_t45_d_b641_e_8c}
\input{_b_m_p280_8c}
\input{fff_8c}
\input{_a_t45_d_b641_e_8h}
\input{_b_m_p280_8h}
\input{fff_8h}
